...
async function main() {
    ...
    data: [
      {
        ...
        nik: "55000154",
        phone: "08983456945",
        image: "/assets/images/users/550001541744816193712.jpg",
        positionId: FR.id,
        departmentId: EI2.id,
      ...
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/550000711744816193712.jpg",
        password: await bcrypt.hash("password", 10),
      ...
      },
      {
        ...
        positionId: SPV.id,
        departmentId: EI6.id,
        image: "/assets/images/users/550001531744816193712.jpg",
        password: await bcrypt.hash("password", 10),
      ...
      },
      {
        ...
        name: "Mark Morton",
        nik: "55000111",
        image: "/assets/images/users/550001111744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/311000031744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: leaderRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/311000351744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/311000991744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: leaderRole.id,
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/311001071744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: leaderRole.id,
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/311001561744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: leaderRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/311001711744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/317020251744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/318040071744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/318040081744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/318040241744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/318110281744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/318120271744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: leaderRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/330000091744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/550000921744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/550000931744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/550000971744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: leaderRole.id,
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/550000991744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: leaderRole.id,
      },
      {
        ...
        positionId: GL.id,
        departmentId: EI2.id,
        image: "/assets/images/users/550001251744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: leaderRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/550001351744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: FR.id,
        departmentId: EI2.id,
        image: "/assets/images/users/600000671744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: userRole.id,
      },
      {
        ...
        positionId: DH.id,
        departmentId: EI2.id,
        image: "/assets/images/users/600001391744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: managementRole.id,
      },
      {
        ...
        positionId: SPV.id,
        departmentId: EI2.id,
        image: "/assets/images/users/600001581744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: managementRole.id,
      },
      {
        ...
        positionId: SPV.id,
        departmentId: EI1.id,
        image: "/assets/images/users/600001701744816193712.jpg",
        password: await bcrypt.hash("password", 10),
        roleId: managementRole.id,
      },
    ],
    ...
    data: [
      {
        ...
        type: "pdf",
        path: "/assets/files/6f709c6e-cb30-45ff-aba4-28c97b13b1ee.pdf",
        userId: doni.id,
      },
    ],
  });
  ...
  await prisma.findingImage.createMany({
    data: [
      {
        findingId: first.id,
        path: "/assets/images/findings/27c55fb8-79aa-384d-9d8d-6051b9858cf3.jpg",
      },
      {
        findingId: first.id,
        path: "/assets/images/findings/670ade30-fe2b-372a-94a2-0409e61c9753.jpg",
      },
      {
        findingId: second.id,
        path: "/assets/images/findings/670ade30-fe2b-372a-94a2-0409e61c9753.jpg",
